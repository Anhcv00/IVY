...
class product
{
    ...
    public function show_brand()
    {
        ...
        from tbl_brand Inner join tbl_cartegory ON tbl_brand.cartegory_id 
        = tbl_cartegory.cartegory_id
    ...
    public function insert_product()
    {
        ...
        $filecheck = strtolower(pathinfo($product_img, PATHINFO_EXTENSION));
        ...
        if (file_exists("uploads/$filetarget")){
            ...
            if($filecheck != "jpg" && $filecheck != "png" && $filecheck != "jpeg"){
